...
public func == <P: RelativeCompoundEquality>(lhs: P, rhs: Expression<P>) -> [NSLayoutConstraint] {
    return lhs.context.addConstraint(from: lhs, to: rhs.value, coefficients: rhs.coefficients)
}
...
public func <= <P: RelativeCompoundInequality>(lhs: P, rhs: Expression<P>) -> [NSLayoutConstraint] {
    return lhs.context.addConstraint(from: lhs, to: rhs.value, coefficients: rhs.coefficients, relation: .lessThanOrEqual)
}
...
@discardableResult
public func >= <P: RelativeCompoundInequality>(lhs: P, rhs: Expression<P>) -> [NSLayoutConstraint] {
    return lhs.context.addConstraint(from: lhs, to: rhs.value, coefficients: rhs.coefficients, relation: .greaterThanOrEqual)
}
